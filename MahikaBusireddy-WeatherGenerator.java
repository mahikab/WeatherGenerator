...
public class WeatherGenerator {
     ...
     */
    public static void populateLocationProbabilities( double[] drywetProbability, double[] wetwetProbability, double longitude, 
    double latitude, double[][] drywet, double[][] wetwet){
     ...
     */
    public static int[] forecastGenerator( double drywetProbability, 
                            double wetwetProbability, int numberOfDays) {
    ...
    public static int[] oneMonthForecast(int numberOfLocations, int month, double longitude, double latitude ){
        ...
        int[] forecast =  forecastGenerator(drywetProbability[month], wetwetProbability[month], days);
        return forecast;
    }
    ...
    public static int bestWeekToTravel(int[] forecast){
        ...
        int num2 = 0;
        int count = 0;
        int[] array = new int[forecast.length];
